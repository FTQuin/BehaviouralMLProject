...
class Experiment:
    ...
    def initialize_experiment(self):
        ...
        self.dataset = datasets.Dataset.Training(self.dataset_path, **self.dataset_params,
                                                 extractor=self.extractor)  # get dataset
...
MODEL_PARAMS = {'model_params': [{'activation_function': 'relu', 'optimizer': 'adam'},
                                 ...
                                 {'activation_function': 'relu', 'optimizer': 'sgd'},
                                 {'activation_function': 'tanh', 'optimizer': 'sgd'},
                                 {'activation_function': 'sigmoid', 'optimizer': 'sgd'}
                                 ]}

FEATURE_EXTRACTORS = {'extractor': [feature_extractors.MobileNetV2Extractor]}
...
# models.GRU.gru1, models.GRU.gru2, models.LSTM.lstm1, models.LSTM.lstm2
MODELS = {'model': [models.GRU.gru1, models.GRU.gru2, models.LSTM.lstm1, models.LSTM.lstm2]}
e = Experiment(
    name='test', batch_size=32, epochs=25,
    dataset_path='../datasets/NTU-6', dataset_params={'seq_len': 20,
                                                      'train_test_split': .8},
...
EXPERIMENT_NAME = 'MobilenetGridSearchEpoch25_NTU-6'
