...
num_features_search = [4196, 2048, 1024]
...
#
# # save data
# np.savez("processed_data", train_data_0=train_data[0], train_data_1=train_data[1], train_labels=train_labels,
...
train_data_0, train_data_1, train_labels, test_data_0, test_data_1, test_labels\
    = [item[1] for item in np.load("processed_data.npz").items()]
